---
title: "Week 5 Classwork: aquatic invertebrates"
...
```{r}
#| label: cleaning-ncos-sites-classwork
#| message: false
...
```{r}
#| label: cleaning-taxon-list-classwork
#| message: false
...
```{r}
#| label: cleaning-water-quality-classwork1
#| message: false
...
```{r}
#| label: cleaning-water-quality-classwork
#| message: false
...
```{r}
#| label: cleaning-aquatic-inverts-classwork
#| message: false
#| warning: false
...
```{r}
#| label: missing-values-classwork
#| message: false
#| warning: false
...
```{r}
#| label: visualizing-salinity-classwork
#| fig-width: 8
#| fig-height: 6
#| message: false
#| warning: false
...
```
```{r}
#| label: copepod-cleaning-classwork
#| message: false
#| warning: false
...
```{r}
#| label: visualizing-copepods-classwork
#| message: false
#| warning: false
#| fig-width: 10
#| fig-height: 6
...
```
```{r}
#| label: site-diff-plots-classwork
#| message: false
#| warning: false
#| fig-width: 8
#| fig-height: 10
